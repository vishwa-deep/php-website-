...
<html lang="en">
  ...
  <a class="navbar-brand" href="register.php">Tech blog</a>
  ...
  <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Guest.php">Guest login</a>
      </li>
...
<h5>Please Register/Already a User Login <a href="login.php" class="btn btn-info" role="button">login</a></h5>
